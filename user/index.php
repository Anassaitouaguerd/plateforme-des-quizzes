                            ...
                            <div class="left-content show-up header-text wow fadeInLeft" data-wow-duration="1s"
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <p> Faciliter l'Administration des Cours, les Quiz Interactifs, et le Suivi de
                                            la Progression des Étudiants</p>
                                    </div>
                                    <div class="col-lg-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 align-self-center  wow fadeInRight" data-wow-duration="1s"
                            ...
                            <div class="about-right-content">
                                ...
                                <p>Ce projet consiste à concevoir et mettre en œuvre une plateforme éducative en ligne
                                    complète, offrant des fonctionnalités telles que la gestion des cours, des quiz
                                    interactifs, le suivi des résultats, et des statistiques pour une expérience
                                    d'apprentissage optimale.</p>
                                <div class="row">
                                            ...
                                            <div>
                                                <div class="thumb">
                                                    <div class="row">
                                                        <div class="col-lg-6 align-self-center">
                                                            <div class="left-text">
                                                                <h4>Proposer de nombreuses formations pour développer
                                                                    vos compétences</h4>
                                            ...
                                            <div>
                                                <div class="thumb">
                                                    <div class="row">
                                                        <div class="col-lg-6 align-self-center">
                                                            <div class="left-text">
                                                                <h4>tout en offrant aux étudiants la possibilité de
                                                                    explorer les cours, passer des quiz, et consulter
                                                                    leurs résultats.</h4>
                                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing
                                                                    elit, sedr do eiusmod deis tempor incididunt ut
                                                                    labore et dolore kengan darwin doerski token.
                                            ...
                                            <div>
                                                <div class="thumb">
                                                    <div class="row">
                                                        <div class="col-lg-6 align-self-center">
                                                            <div class="left-text">
                                                                <h4>Cette plateforme propose une expérience éducative
                                                                    complète, entièrement gratuite, offrant des cours,
                                                                    des quiz interactifs et un suivi détaillé de la
                                                                    progression des étudiants sans aucun coût.</h4>
                                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing
                                                                    elit, sedr do eiusmod deis tempor incididunt ut
                                                                    labore et dolore kengan darwin doerski token.
                                                                    dover lipsum lorem and the others.</p>
                                            ...
                                            <div>
                                                <div class="thumb">
                                                    <div class="row">
                                                        <div class="col-lg-6 align-self-center">
                                                            <div class="left-text">
                                                                <h4>La fonctionnalité de statistiques de cette
                                                                    plateforme </h4>
                                                                <p>La fonctionnalité de statistiques de cette plateforme
                                                                    offre aux administrateurs une vue d'ensemble des
                                                                    performances, incluant le nombre total de quiz
                                                                    passés, le nombre d'utilisateurs enregistrés, et des
                                                                    graphiques illustrant la progression individuelle
                                                                    des étudiants.</p>
                                                                <div class="ticks-list"><span><i
                                                                            class="fa fa-check"></i> Optimized
                                                                        Template</span> <span><i

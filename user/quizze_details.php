...
}else if(!isset($_SESSION['roleUser'])){
                    ...
                    <div class="container mt-4">
                      ...
                      ?>
                            <div class="reponse mt-4 col-lg-6 p-3 shadow">
                                <label for="reponse1" class="p-2" style="font-weight: bold; font-size: x-large;">Réponse
                                    <?=$j++?> :</label> <br>
                                <input type="radio" name="reponse<?=$reponse_id?>" required id="reponse1"
                                    value='<?=$answer["answerID"]?>' class="form-check-input">
